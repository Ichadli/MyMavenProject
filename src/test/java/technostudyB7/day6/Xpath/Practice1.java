    ...
    /*Test Case:
      ...
      9- Check if you see your products*/
        ...
        * <a href="#" id="item_4_title_link">
        ...
        WebElement checkProduct1 = driver.findElement(By.xpath("(//div[@class='inventory_item_name'])[1]"));
        WebElement checkProduct2 = driver.findElement(By.xpath("(//div[@class='inventory_item_name'])[2]"));


        List<String> checkOutList = new ArrayList<>();
        checkOutList.add(checkProduct1.getText());
        checkOutList.add(checkProduct2.getText());

        System.out.println(checkOutList.contains(product1));
